...
/**
 * The persistent class for the sanction_customer database table.
 * 
 */
@Entity
@Table(name="sanction_customer")
@NamedQuery(name="SanctionCustomer.findAll", query="SELECT s FROM SanctionCustomer s")
public class SanctionCustomer  extends BaseEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GenericGenerator(name = "generator", strategy = "increment")
	@GeneratedValue(generator = "generator")
	@Column(name="san_cust_sno")
	private int sanCustSno;
	...
	//bi-directional many-to-one association to SanctionCustomerVersion
	@OneToMany(mappedBy="sanctionCustomer")
	private List<SanctionCustomerVersion> sanctionCustomerVersions;
	...
	public SanctionCustomer() {
	}

	public int getSanCustSno() {
		return this.sanCustSno;
	}

	public void setSanCustSno(int sanCustSno) {
		this.sanCustSno = sanCustSno;
	}
	...
	public List<SanctionCustomerVersion> getSanctionCustomerVersions() {
		return this.sanctionCustomerVersions;
	}

	public void setSanctionCustomerVersions(List<SanctionCustomerVersion> sanctionCustomerVersions) {
		this.sanctionCustomerVersions = sanctionCustomerVersions;
	}

	public SanctionCustomerVersion addSanctionCustomerVersion(SanctionCustomerVersion sanctionCustomerVersion) {
		getSanctionCustomerVersions().add(sanctionCustomerVersion);
		sanctionCustomerVersion.setSanctionCustomer(this);

		return sanctionCustomerVersion;
	}

	public SanctionCustomerVersion removeSanctionCustomerVersion(SanctionCustomerVersion sanctionCustomerVersion) {
		getSanctionCustomerVersions().remove(sanctionCustomerVersion);
		sanctionCustomerVersion.setSanctionCustomer(null);
