...
/**
 * The persistent class for the staff_dim_ncore database table.
 * 
 */
@Entity
@Table(name="staff_dim_ncore", schema="rskncore")
@NamedQuery(name="StaffDimNcore.findAll", query="SELECT s FROM StaffDimNcore s")
public class StaffDimNcore implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="STAFF_SNO")
	private long staffSno;
	...
	@Column(name="STAFF_CAT")
	private String staffCat;

	@Column(name="STAFF_NUM")
	private String staffNum;

	@Column(name="STAFF_SINCE_DT")
	private Date staffSinceDt;

	@Column(name="STAFF_SUB_CAT")
	private String staffSubCat;
	...
	@OneToMany(mappedBy="staffDimNcore")
	...
	public StaffDimNcore() {
	}

	public long getStaffSno() {
		return this.staffSno;
	}

	public void setStaffSno(long staffSno) {
	...
	public Date getStaffSinceDt() {
		return this.staffSinceDt;
	}

	public void setStaffSinceDt(Date staffSinceDt) {
		this.staffSinceDt = staffSinceDt;
	}

	public String getStaffSubCat() {
		return this.staffSubCat;
	}

	public void setStaffSubCat(String staffSubCat) {
		this.staffSubCat = staffSubCat;
	}
	...
	public NonFinTranFactNcore addNonFinTranFactNcore(NonFinTranFactNcore nonFinTranFactNcore) {
		...
		nonFinTranFactNcore.setStaffDimNcore(this);
	...
	public NonFinTranFactNcore removeNonFinTranFactNcore(NonFinTranFactNcore nonFinTranFactNcore) {
		...
		nonFinTranFactNcore.setStaffDimNcore(null);
	...
	public FinTranFactNcore addFinTranFactNcore(FinTranFactNcore finTranFactNcore) {
		...
		finTranFactNcore.setStaffDimNcore(this);
	...
	public FinTranFactNcore removeFinTranFactNcore(FinTranFactNcore finTranFactNcore) {
		...
		finTranFactNcore.setStaffDimNcore(null);
