...
/**
 * The persistent class for the sanction_customer_request database table.
 * 
 */
@Entity
@Table(name="sanction_customer_request")
@NamedQuery(name="SanctionCustomerRequest.findAll", query="SELECT s FROM SanctionCustomerRequest s")
public class SanctionCustomerRequest extends BaseEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GenericGenerator(name = "scrno",strategy = "increment")
	@GeneratedValue(generator="scrno")
	@Column(name="screq_sno")
	private int screqSno;
	...
	public SanctionCustomerRequest() {
	}

	public int getScreqSno() {
		return this.screqSno;
	}

	public void setScreqSno(int screqSno) {
		this.screqSno = screqSno;
	}
