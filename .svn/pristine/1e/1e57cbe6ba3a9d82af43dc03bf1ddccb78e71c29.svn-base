 ...
 */
@Entity
@Table(name="ext_party_dim_ncore", schema="rskncore")
@NamedQuery(name="ExtPartyDimNcore.findAll", query="SELECT e FROM ExtPartyDimNcore e")
public class ExtPartyDimNcore implements Serializable {
	...
	@ManyToMany(mappedBy="extPartyDimNcores")
	...
	public FinTranFactNcore addFinTranFactNcore(FinTranFactNcore finTranFactNcore)
	{
		...
		finTranFactNcore.setExtParyDimNcore(this);
	...
	public FinTranFactNcore removeFinTranFactNcore(FinTranFactNcore finTranFactNcore)
	{
		...
		finTranFactNcore.setExtParyDimNcore(null);
		return finTranFactNcore;
	}
